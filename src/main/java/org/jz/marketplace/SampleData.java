...
public class SampleData {
	...
	public static List<Project> getProjects() {
		...
		p.setDeadline(LocalDateTime.of(2017, 10, 01, 13, 30, 0));
		...
		p.setDeadline(LocalDateTime.of(2017, 11, 01, 11, 10, 0));
		p.setSeller(getUsers().get(2));
		p.setStartingBid(50);
		...
		p = new Project();
		p.setBillingType(BillingType.FIXED);
		p.setDeadline(LocalDateTime.of(2017, 11, 05, 15, 15, 0));
		p.setSeller(getUsers().get(2));
		...
		p = new Project();
		p.setBillingType(BillingType.HOURLY);
		p.setDeadline(LocalDateTime.of(2017, 11, 15, 9, 0, 0));
